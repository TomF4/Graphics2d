...
void Sprite::getSpriteInfo()
{
	std::cout << "m_vaoID"   << m_vaoID << std::endl;
	std::cout << "m_vboID[0]"<< m_vboID[0] << std::endl;
	std::cout << "m_vboID[1]"<< m_vboID[1] << std::endl;
	std::cout << "m_Width"   << m_Width << std::endl;
	std::cout << "m_Height"  << m_Height << std::endl;
	std::cout << "m_NumberOfVerts"<< m_NumberOfVerts << std::endl;
	std::cout << "m_xpos"    << m_xpos << std::endl;
	std::cout << "m_ypos"    << m_ypos << std::endl;
}
...
void Sprite::Init(Shader& shader, float colour[3], std::string filename, float repeatInS, float repeatInT)
{
	//load png image
	int imageHeight = 0;
	int imageWidth  = 0;
	...
	float tex[12];
	//left														
	tex[0]  = 0.0f;			 tex[1]  = repeatInS;
	tex[2]  = 0.0f;			 tex[3]  = 0.0;
	tex[4]  = repeatInS;	 tex[5]  = 0.0;
	//right							 
	tex[6]  = 0.0f;			 tex[7]  = repeatInT;
	tex[8]  = repeatInT;	 tex[9]  = repeatInT;
	tex[10] = repeatInT;	 tex[11] = 0.0;
